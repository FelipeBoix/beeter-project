...
public class BeeterRootAPI {
	@InjectLinks({// mis enlaces son un array. A partir del resource podemos ver la UR ABSOLUTE.Tipo d emedia con el que trabaja ese recurso.
	...
	private List<Link> links;// como le llamo
